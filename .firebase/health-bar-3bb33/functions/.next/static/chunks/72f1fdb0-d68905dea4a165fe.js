 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e4(e,t,r=!1){if((0,n.rh)(e.app))return Promise.reject(g(e));let i="signIn",s=await e3(e,i,t),a=await eZ._fromIdTokenResponse(e,i,s);return r||await e._updateCurrentUser(a.user),a}async function e5(e,t){return e4(ey(e),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e6(e){let t=ey(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}async function e8(e,t,r){if((0,n.rh)(e.app))return Promise.reject(g(e));let i=ey(e),s=eP(i,{returnSecureToken:!0,email:t,password:r,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",eQ),a=await s.catch(t=>{throw"auth/password-does-not-meet-requirements"===t.code&&e6(e),t}),o=await eZ._fromIdTokenResponse(i,"signIn",a);return await i._updateCurrentUser(o.user),o}function e7(e,t,r){return(0,n.rh)(e.app)?Promise.reject(g(e)):e5((0,s.m9)(e),eq.credential(t,r)).catch(async t=>{throw"auth/password-does-not-meet-requirements"===t.code&&e6(e),t})}function te(e,t,r,i){return(0,s.m9)(e).onAuthStateChanged(t,r,i)}function tt(e){return(0,s.m9)(e).signOut()}new WeakMap;let tr="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

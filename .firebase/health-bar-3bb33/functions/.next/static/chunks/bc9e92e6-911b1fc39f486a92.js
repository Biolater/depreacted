"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{IO:function(){return i5},JU:function(){return ix},PL:function(){return sc},QT:function(){return su},ad:function(){return iM},ar:function(){return i7},hJ:function(){return iR},pl:function(){return sd}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(9109).lW;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function su(e){e=iS(e,ib);let t=iS(e.firestore,iV);return(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ic({next:s=>{t.enqueueAndForget(()=>rU(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rz(new e8(n.path),s,{includeMetadataChanges:!0,_a:!0});return rP(e,a)})(await iv(e),e.asyncQueue,t,n,r)),r.promise})(iO(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new sh(e);return new sa(e,i,t._key,r,new ss(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class sh extends si{constructor(e){super(),this.firestore=e}convertBytes(e){return new iP(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new ib(this.firestore,null,t)}}function sc(e){e=iS(e,ik);let t=iS(e.firestore,iV),n=iO(t),r=new sh(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new S(C.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new rz(n,new ic({next:n=>{t.enqueueAndForget(()=>rU(e,s)),n.fromCache&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),{includeMetadataChanges:!0,_a:!0});return rP(e,s)})(await iv(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sl(t,r,e,n)))}function sd(e,t,n){var r,i;e=iS(e,ib);let s=iS(e.firestore,iV),a=(r=e.converter)?n&&(n.merge||n.mergeFields)?r.toFirestore(t,n):r.toFirestore(t):t;return i=[(function(e,t,n,r,i,s={}){let a,o;let l=e.Nu(s.merge||s.mergeFields?2:0,t,n,i);iJ("Data must be an object, but it was:",l,r);let u=iY(r,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=function(e,t,n){if((t=(0,h.m9)(t))instanceof iU)return t._internalPath;if("string"==typeof t)return i0(e,t);throw i1("Field path arguments must be of type string or ",e,!1,void 0,n)}(t,r,n);if(!l.contains(i))throw new S(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iK(new eO(u),a,o)})(iW(s),"setDoc",e._key,a,null!==e.converter,n).toMutation(e._key,tR.none())],function(e,t){let n=new A;return e.asyncQueue.enqueueAndForget(async()=>r2(await iy(e).then(e=>e.syncEngine),t,n)),n.promise}(iO(s),i)}new WeakMap,function(e=!0){p=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iV(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.0",void 0),(0,o.KN)(m,"4.7.0","esm2017")}()}}]);